...
def generate_pdf(filename):
    ...
    story.append(Paragraph("Duration: 7 Months", styles['SubTitle']))
    story.append(Spacer(1, 2*cm))
    story.append(Paragraph("Based on the 'Become a Data Scientist' Curriculum", styles['SubTitle']))
    ...
    for module in PLAN_DATA['modules']:
        ...
        for week in module['weeks']:
            ...
            for day in week['days']:
                ...
                # If it's the detailed day, it might have <br/> already or newlines
                # Just replace newlines with <br/> if they are genuine line breaks
...
if __name__ == "__main__":
    generate_pdf("Data_Science_Study_Plan.pdf")
